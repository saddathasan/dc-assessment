// Proves the per-Section data-layer contract end to end (useSectionQuery →
// SectionBoundary): skeleton announced while loading, content on success,
// error state with a working retry on failure.
