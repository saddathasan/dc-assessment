...
export function SolutionCards({ cards }: { cards: ValueCard[] }) {
  return (
    ...
    <ul
      ...
      className="flex h-[394px] snap-x snap-mandatory items-center gap-5 overflow-x-auto px-5 [scrollbar-width:none] lg:mx-auto lg:h-[450px] lg:max-w-[1440px] lg:snap-none lg:gap-4 lg:px-0 lg:[justify-content:safe_center] [&::-webkit-scrollbar]:hidden"
    >
      {cards.map((card) => (
